	...
	require([ "dojo/parser", "esri/map", "esri/dijit/Scalebar",
		...
		function(parser, Map, Scalebar, ArcGISDynamicMapServiceLayer,WMSLayer,
			...
			function setQuylist(data,layid){			
				...
				$("#resuCount").text(features.length);
...
/* 				var	resu
						'<span id="sp1-'+row.dataid+'" style="font-size:14px" class="glyphicon glyphicon-eye-close" title="显示快视图" onclick=showove('+JSON.stringify(row)+','+index+');></span>'
						
						+'<span id="sp2-'+row.dataid+'" style="font-size:14px" class="glyphicon glyphicon-screenshot" title="配对查询" onclick=imageMatch('+JSON.stringify(row)+');></span>' 
			...
			function SeleGraphic(event){
				...
				for(var i=0;i<graphics.length;i++){
					...
					if(tmpgra.geometry.contains(pnt)){
						...
						/* $(resudata).each(function(index,item) */
						...
						<div class="tabbable" id="tabs-237916">
							<ul id="navtabid" class="nav nav-tabs">
								<li class="active" style="width:50%">
									 <a href="#panel-quyterm" data-toggle="tab">查询条件</a>
								</li>
								<li style="width:50%">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="panel-quyterm" style="height:100%">
									<!-- 第二级选项卡 -->
									<div class="row-fluid clearfix" style="height:25%">
											...
											<div class="tabbable" id="tabs-724236">
												...
												<div class="tab-content">
													<div class="tab-pane active" id="panel-region">
														<table width=100% height=60% style="padding-top:15px">
															<tr height=30%>
													...
													<div class="tab-pane" id="panel-importshp">
														...
														<div class="input-append" >  
														    ...
														    <a class="btn btn-default" style="margin-left:-5px;margin-top:-1px" onclick="$('input[id=uploadSHPfile]').click();">Browse</a>  
													...
													<div class="tab-pane" id="panel-132828">
														<div style="text-align:center;width:100%;height:50px;margin-top:12px;">
															<div class="form-group" >
																<label class="col-lg-3" style="text-align:right;padding-right:5px;padding-top:5px">对角点1 经度</label><input type="text" id="PntX1" class="InputXYbox form-control col-lg-3" style="text-align:center;width:120px;" onkeyup="checkNum(this,-180,180);"/>
																<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:5px;"> 纬度</label>	<input type="text" id="PntY1" class="InputXYbox form-control col-lg-3" style="text-align:center;width:120px;" onkeyup="checkNum(this,-90,90);"/>
															</div>
															<div class="form-group" style="margin-top:20px;">
																<label class="col-lg-3" style="text-align:right;padding-right:5px;padding-top:5px">对角点2 经度</label><input type="text" id="PntX2" class="InputXYbox form-control col-lg-3" style="text-align:center;width:120px;" onkeyup="checkNum(this,-180,180);"/>
																<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:5px"> 纬度</label>	<input type="text" id="PntY2" class="InputXYbox form-control col-lg-3" style="text-align:center;width:120px;" onkeyup="checkNum(this,-90,90);"/>
															</div>
													...
													<div class="tab-pane" id="panel-importTxt">
														<div style="text-align:center; padding-top:15px">
									...
									<form id="qureyform" style="height:70%">
										...
										<table style="width:100%;height:350px">
											<tr height="10%">
											<td width="20%" style="text-align:left; padding-right:0px;">
												采集日期
											</td>
											<td width="80%" style="text-align:center; padding-right:0px;">
												<input id="date1" name="date1" class="Wdate" type="text" style="width:150px;font-size:13px" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'2012-01-01 00:00:00',maxDate:'#F{$dp.$D(\'date2\')||\'new Date()\'}'})"/>
			     							  	至 <input id="date2" name="date2" class="Wdate" type="text" style="width:150px;font-size:13px" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'date1\')}',maxDate:'%y-%M-%d'})"/> 
											</td>
											</tr>
											<tr height="10%">
											<td width="20%" style="text-align:left; padding-right:0px;">
											...
											<td width="80%" style="text-lign:center; padding-left:15px;">
											...
											<td width="20%" style="text-align:right; padding-right:0px;">
												资源三号01星
											</td>
											...
											<td width="80%" style="text-align:center; padding-left:15px;">
												<div style="float:left;padding-right:15px;"><label id="couldmin" >0</label></div>
												<div style="padding-top:8px;width:80%;float:left;"><div id="slider" style=""></div></div>
											...
											<td width="80%">
												<div class="form-group" style="padding-left:15px;">
													<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:10px">轨道号</label> <div class="col-lg-3" style="text-align:left;padding-left:5px"><input type="text" id="orbitid" name="orbitid" class="form-control" style="text-align:center;width:120px;"/></div>
													<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:10px">产品号</label> <div class="col-lg-3" style="text-align:left;padding-left:5px"><input type="text" id="dataid" name="dataid" class="form-control" style="text-align:center;width:120px;"/></div>
												</div>
											</td>
											</tr>
											<tr height="10%">
											...
											<td width="80%" >
												<div class="form-group" style="padding-left:15px;">
													<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:10px">PATH</label> <div class="col-lg-3" style="text-align:left;padding-left:5px"><input type="text" id="scenerow" name="scenerow" class="form-control" style="text-align:center;width:120px;"/></div> 
													<label class="col-lg-2" style="text-align:right;padding-right:5px;padding-top:10px">ROW</label> <div class="col-lg-3" style="text-align:left;padding-left:5px"><input type="text" id="scenepath" name="scenepath" class="form-control" style="text-align:center;width:120px;"/></div>
												</div>
