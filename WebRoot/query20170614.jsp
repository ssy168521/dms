						...
						<div class="tabbable" id="tabs-237916">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="panel-quyterm" style="height:100%">
									...
									<form id="qureyform">
										...
										<table style="width:100%;height:350px">
											...
											<td width="80%">
												<div class="form-group">
													<label class="col-lg-2" style="text-align:left">轨道号</label> <div class="col-lg-3" style="text-align:left"><input type="text" id="orbitid" name="orbitid" class="form-control" style="text-align:center;width:100%;"/></div>
													<label class="col-lg-2" style="text-align:left">产品号</label> <div class="col-lg-3" style="text-align:left"><input type="text" id="dataid" name="dataid" class="form-control" style="text-align:center;width:100%;"/></div>
												</div>
											</td>
											</tr>
											<tr height="10%">
								...
								<!-- 	<button id="DeleteDataId" type="button" class="btn btn-default" title="删除" href="javascript:void(0)">
									 ...
									 -->
									<table id="resulist" class="table table-striped table-hover table-condensed"></table>
