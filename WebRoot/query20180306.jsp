							...
							<div class="tab-content">
								<div class="tab-pane active" id="panel-quyterm" style="height:100%">
											...
											<div class="tabbable" id="tabs-724236">
												...
												<div class="tab-content">
													...
													<div class="tab-pane" id="panel-importTxt">
														<div style="text-align:center; padding-top:15px">
															<input id="uploadtxt" type="file" size="45" accept="text/plain" name="uploadTXT" style="display:none">
															<div class="input-append" >  
															    文件：
															    <input id="selectedtxt" class="input-large" type="text" style="height:33px;">  
															    <a class="btn btn-default" style="margin-left:-5px;margin-top:-1px" onclick="$('input[id=uploadtxt]').click();">浏览</a>  
									...
									<ul class="nav nav-tabs">
													...
													<li style="width:33%">
														 <a href="#panel-importshp" data-toggle="tab">标准分幅影像</a>
													</li>
													<li style="width:33%">
														 <a href="#panel-132828" data-toggle="tab">分景影像</a>
													</li>

												</ul>
									<div class="query-content">
									<div class="tab-query" id="sc-query-region">			
									<form id="qureyform">
