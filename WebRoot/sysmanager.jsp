...
<div class="header bg-main" style="background-image: url(img/page/bannerbg.jpg);background-size:110px auto;background-repeat:repeat">
  <div class="logo margin-big-left fadein-top">   
   ...
   <div style="float:right;margin-top:30px">
   	<label style="font-size:24px;color:white">系统管理</label>
   </div>
  </div>
  <!-- <div class="head-l">
  <a class="button button-little bg-green" href="./home.jsp"><span class="icon-home"></span> 首    页</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <!--   <h2><span class="icon-user"></span>任务管理</h2>
  <ul style="display:block">
    <li><a href="./jsp/TaskInfo.jsp" target="right"><span class="icon-caret-right"></span>任务信息</a></li>
  </ul>  -->
   <h2><span class="icon-user"></span>用户管理</h2>
  <ul style="display:block">
    <li><a href="./jsp/user.jsp" target="right"><span class="icon-caret-right"></span>用户管理</a></li>
    <li><a href="./jsp/role.jsp" target="right"><span class="icon-caret-right"></span>角色管理</a></li>
    <li><a href="./jsp/priv.jsp" target="right"><span class="icon-caret-right"></span>权限管理</a></li>        
  </ul> 
  <h2><span class="icon-cogs"></span>数据管理</h2>
  <ul style="display:block">
   <!--  <li><a href="" target="right"><span class="icon-caret-right"></span>系统配置</a></li>
    <li><a href="" target="right"><span class="icon-caret-right"></span>数据库配置</a></li>    -->
    <li><a href="./jsp/Datamanager.jsp" target="right"><span class="icon-caret-right"></span>数据管理</a></li>      
  </ul> 
</div>
...
<ul class="bread">
	<li><a href="./jsp/user.jsp" target="right" class="icon-home"> 首页</a></li>
	<li><a href="##" id="a_leader_txt"> </a></li>
</ul>
<div class="admin">
	<iframe scrolling="auto" rameborder="0" src="./jsp/user.jsp" name="right" width="100%" height="99%"></iframe>
</div>
