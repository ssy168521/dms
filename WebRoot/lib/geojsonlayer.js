    ...
    return declare([GraphicsLayer], {
        ...
        constructor: function (options) {
            ...
            if (options.infoTemplate !== false) {
                this.setInfoTemplate(options.infoTemplate || new InfoTemplate("数据详情", "${*}"));
            }
            // Renderer
            if (options.renderer) {
            ...
            // Manage drawing
            this._maxDraw = options.maxdraw || 10000;  // default to 1000 graphics
            console.log(this._maxDraw);
            console.log(options.maxdraw);
            this._drawCount = 0;
        ...
        _setDefaultSymbols: function () {
            ...
            this._simplePolygonSym = new SimpleFillSymbol("solid",
                    new SimpleLineSymbol("solid", new Color([50, 50, 50, 0.15]), 2),
                    getRandomColor("green", 0));//0为透明
        ...
        _addGraphics: function (arcgisJson) {
            ...
            if (arcgisJson.length > this._maxDraw) {
                ...
                alert("查询结果数据集超过限制，仅绘制前" + this._maxDraw + "条记录!");
            ...
            console.log("drawing the " + i + " features!");
            // Call onLoad
